...
export async function generateRAGAnswer(queryText, workspaceId, conversationHistory = []) {
    try {
        ...
        // 🔥 NEW: Greeting detection (skip RAG entirely)
        ...
        if (greetings.some(g => lowerQuery === g || lowerQuery.startsWith(g + ' '))) {
            ...
            return {
                answer: "Hello there! 👋 How can I assist you with our products or services today? Feel free to ask me about pricing, features, or support. What brings you here?",
                sources: [],
                confidence: 'high',
                hasKnowledge: true,
            };
        ...
        if (relevantChunks.length === 0) {
            // 🔥 NEW: Better fallback for unrelated questions
            console.log('❌ No relevant knowledge found');
            return {
                answer: "I'm sorry, I don't have information about that. I'm specifically trained on our company's products, services, pricing, and policies. Could you please ask something related to those? For example: 'What services do you offer?' or 'What is your pricing?'",
                sources: [],
                confidence: 'low',
                hasKnowledge: false,
            };
